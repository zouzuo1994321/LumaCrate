...
![Version](https://img.shields.io/badge/version-v1.32.0-blue.svg)

![Platform](https://img.shields.io/badge/platform-Windows%2010%2F11-lightgrey.svg)

![Python](https://img.shields.io/badge/Python-3.13-3776AB.svg)

![License](https://img.shields.io/badge/license-open--source·no--commercial-orange.svg)

![Build](https://img.shields.io/badge/build-2609240043-success.svg)
...
| :-------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------: |
|                                             Toolbox nav                                             |                                                               Duplicate detection                                                              |
...
- Go to **[GitHub Releases](https://github.com/zouzuo1994321/LumaCrate/releases)** and download the latest `流明盒-v1.32.0-<build>.exe`;
